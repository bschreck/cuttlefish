...
class Transport(MackieControlComponent):
    __module__ = __name__
    __doc__ = 'Representing the transport section of the Mackie Control: '
            ...
            if (not (self._Transport__forward_button_down and self._Transport____rewind_button_down)):
                if self._Transport__forward_button_down:
                    ...
                    if (not self.alt_is_pressed()):
                        self._Transport__fast_forward((base_acceleration + max(1, (self._Transport____fast_forward_counter / 4))))
                    else:
                ...
                if self._Transport____rewind_button_down:
                    ...
                    if (not self.alt_is_pressed()):
                        self._Transport__rewind((base_acceleration + max(1, (self._Transport__fast___rewind_counter / 4))))
                    else:
